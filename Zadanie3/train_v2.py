import numpy as np
import torch as T
from src_v2.agent import DDPGAgent
from src_v2.Noise import OrnsteinUhlenbeckActionNoise, NormalActionNoise
import os
import argparse
import json
import gym
...
if __name__ == "__main__":
    ...
    counter = 1
    env_path = os.path.join("src_v2/experiments", args.env)
